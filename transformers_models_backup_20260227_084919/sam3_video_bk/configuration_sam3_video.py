...
class Sam3VideoConfig(PreTrainedConfig):
    ...
    Args:
        ...
        delay_memory_update_until_verified (`bool`, *optional*, defaults to `False`):
            Whether to delay SAM2 memory encoding until an explicit post-forward commit step. When enabled, planning
            stores per-frame pending memory candidates and memory is encoded only when committed.
    ...
    def __init__(
        ...
        delay_memory_update_until_verified=False,
        # Hotstart parameters
        hotstart_delay=15,
        ...
        **kwargs,
        ...
        self.delay_memory_update_until_verified = delay_memory_update_until_verified
